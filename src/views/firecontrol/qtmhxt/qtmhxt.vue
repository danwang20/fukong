<template>
  <div class="qtmh">
    <div class="qtmh_left">
      <img
        style="position: relative; top: 60px; width: 55%"
        src="../../../assets/svg/气体灭火系统.svg"
        alt="111"
      />
    </div>
    <div class="qtmh_center">
      <section class="qtmh_center_1">
        <ButtonMessage :item="items.item0" />
      </section>
      <section class="qtmh_center_2">
        <ButtonMessage :item="items.item1" />
      </section>
      <section class="qtmh_center_3">
        <ButtonMessage :item="items.item2" />
      </section>
      <section class="qtmh_center_4">
        <ButtonMessage :item="items.item3" />
      </section>
      <section class="qtmh_center_5">
        <ButtonMessage :item="items.item4" />
      </section>
    </div>
    <div class="qtmh_right">
      <section class="qtmh_right_1">
        <MessageBox :option="options.option1"
        />
      </section>
      <section class="qtmh_right_2">
        <MessageBox
