  ...
  <div class="byqspwmh">
    <div class="byqspwmh_left">
      <img
        ...
        src="../../../assets/svg/水喷雾灭火.svg"
        alt="111"
      />
    </div>
    <div class="byqspwmh_center">
      <section class="byqspwmh_center_1">
        <ButtonMessage :item="items.item0" />
      </section>
      <section class="byqspwmh_center_2">
        <ButtonMessage :item="items.item1" />
      </section>
      <section class="byqspwmh_center_3">
        <ButtonMessage :item="items.item2" />
      </section>
      <section class="byqspwmh_center_4">
        <ButtonMessage :item="items.item3" />
      </section>
      <section class="byqspwmh_center_5">
        <ButtonMessage :item="items.item4" />
      </section>
    </div>
    <div class="byqspwmh_right">
      <section class="byqspwmh_right_1">
        <MessageBox :option="options.option1"
        />
      </section>
      <section class="byqspwmh_right_2">
        <MessageBox
